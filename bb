...
#print(tag_head.contents)   # [<title>The Dormouse's story</title>]
...
#str_title = tag_title.contents[0]
#print(str_title)           # The Dormouse's story
#print(type(str_title))     # <class 'bs4.element.NavigableString'>
##print(str_title.contents) # AttributeError: 'NavigableString' object has no attribute 'contents'

#tag_head = soup.head;
#print(type(tag_head.children))  # <class 'list_iterator'>
#print(tag_head.children)        # <list_iterator object at 0x000000000434D320>
#for child in tag_head.children:
